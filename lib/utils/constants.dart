...
Map<int, Color> color0 = {
  50: const Color.fromRGBO(255, 57, 81, .1),
  100: const Color.fromRGBO(255, 57, 81, .2),
  200: const Color.fromRGBO(255, 57, 81, .3),
  300: const Color.fromRGBO(255, 57, 81, .4),
  400: const Color.fromRGBO(255, 57, 81, .5),
  500: const Color.fromRGBO(255, 57, 81, .6),
  600: const Color.fromRGBO(255, 57, 81, .7),
  700: const Color.fromRGBO(255, 57, 81, .8),
  800: const Color.fromRGBO(255, 57, 81, .9),
  900: const Color.fromRGBO(255, 57, 81, 1.0),
};
...
MaterialColor primaryColor = MaterialColor(0xFF0066FF, color0);
